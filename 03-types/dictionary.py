...
cars = {
    'Škoda': {
        'models': tuple(('Fabia', 'Scala', 'Kamiq')),
        'founders': set(('Václav Klement', 'Václav Laurin')),
        'other': list((1895, 'Mladá Boleslav'))
    },
    'Volkswagen': {
        'models': tuple(('Arteon', 'Beetle')),
        'founders': set(('German Labour Front', 'Adolf Hitler')),
        'other': list((1937, 'Wolfsburg'))
    },
    'Audi': {
        'models': tuple(('A1', 'A3', 'A4')),
        'founders': set(('August Horch', 'Jørgen Rasmussen')),
        'other': list((1909, 'Ingolstadt', 'Berlin'))
    }
}

cars['Volkswagen']['models'] += tuple(('Golf', 'Passat'))
del cars['Audi']['other'][2]

print('\nSlovník cars')
print('-----------------------------------------------------------------')
print('firma          models          founders          other')
print('-----------------------------------------------------------------')
for key, value in cars.items():
    print(f"{key} {value['models']} {value['founders']} {value['other']}")
print('-----------------------------------------------------------------')
=======
'''
Slovníky (dictionaries) podobně jako seznamy v sobě obsahují další hodnoty.
...
Počet záznamů: 3
'''
>>>>>>> 844ab0900e8f2526dc52dc34e9b5e0b2342bde69
