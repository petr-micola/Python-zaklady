...
x = 0
# global = 1 - identifikátor nesmí obsahovat klíčové slovo
Global = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - identifikátor nesmí obsahovat symboly @,-,.
hilda_sspuopava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - identifikátor nesmí začínat numerickým znakem
agent007 = 'James Bond'
